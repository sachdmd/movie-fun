...
public class AlbumsUpdateScheduler {
    ...
    private final JdbcTemplate movieJDCTemplate;
    private final Logger logger = LoggerFactory.getLogger(getClass());

    public AlbumsUpdateScheduler(AlbumsUpdater albumsUpdater,JdbcTemplate movieJDCTemplate) {
        this.movieJDCTemplate=movieJDCTemplate;
    ...
    private boolean startAlbumSchedulerTask() {
        int updatedRows = movieJDCTemplate.update(
